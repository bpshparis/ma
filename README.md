...
- [Setup environment](#setup-environment)
  ...
  * [Create Discovery Collection](#create-discovery-collection)
    + [Store Discovery version in DSC_VERSION environment variable](#store-discovery-dsc_version-in-version-environment-variable)
    + [Store Discovery language in DSC_COLL_LANG environment variable](#store-discovery-language-in-dsc_coll_lang-environment-variable)
